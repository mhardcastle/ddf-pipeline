...
labels=['Miscellaneous','Dynspec','Clipcal','Shift','Wide-field KillMS','KillMS phase 60sb','KillMS amp/phase 60sb', 'KillMS amp/phase full', 'KillMS amp/phase full 2', 'Wide-field DDF dirin', 'Predict wide-field', 'DDF dirin', 'DDF phase 60sb', 'DDF amp-phase 60sb', 'DDF band images','DDF full', 'DDF full 2', 'DDF full low QU','DDF full low V','DDF full low', 'DDF bootstrap', 'DDF bootstrap single-band','KillMS DIS0','KillMS DDS0','KillMS DIS1','KillMS DDS1','KillMS DIS2','KillMS DDS2','KillMS DDS3','DDF full DI','DDF predict']
