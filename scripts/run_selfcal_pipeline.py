...
def do_rsync_upload(cname,basedir,f):
    ...
    while True:
        s= 'rsync -avz --relative --progress --chmod=ugo+rX --safe-links --partial --timeout=20 '+' '.join(f)+' '+target+'/disks/paradata/shimwell/LoTSS-DR2/archive_extract/'+cname +'/selfcal/' 
