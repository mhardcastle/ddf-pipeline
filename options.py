...
option_list = ( ( 'machine', 'NCPU_DDF', int, getcpus(),
                ...
                ( 'image', 'final_psf_arcsec', float, 'Final image restored with this PSF size in arcsec' ),
                ...
                ( 'image', 'HMPsize', int, None, 'Island size to use HMP initialization' ),
                ...
                ( 'bootstrap', 'use_mpi', bool, False, 'If True, use MPI to speed up emcee') ,
                ...
                ( 'bootstrap', 'frequencies', list, None, 'Frequencies for catalogues' ), 
                ( 'bootstrap', 'names', list, None, 'Short names for catalogues' ), 
                ( 'bootstrap', 'radii', list, None, 'Crossmatch radii for catalogues' ) )
