...
option_list = ( ( 'machine', 'NCPU', int, getcpus() ),
                ( 'image', 'pbimage', str, 'image_full_ampphase_di_m.NS.int.restored.fits', 'PB-corrected image to use for source finding' ),
                ( 'image', 'nonpbimage', str, 'image_full_ampphase_di_m.NS.app.restored.fits', 'PB-uncorrected image to use for source finding' ),
