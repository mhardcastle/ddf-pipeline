...
option_list = ( ( 'machine', 'NCPU_DDF', int, getcpus(),
                ...
                ( 'solutions', 'auto_dt_ch_di',bool, True, 'Automatically select dt and NChanSols for DI calibration ste[s'),
                ...
                ( 'masking', 'threshold_low', float, 3, 'Masking threshold for image_full_low'),
