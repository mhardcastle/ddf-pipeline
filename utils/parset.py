...
option_list = (
    ...
    ( 'image',      'wscms_flux_threshold',   list,  [1e-5, 1e-5, 1e-6, 1e-6], "WSCMS2 absolute clean floor (Jy) per pipeline step; backstop against pathological over-cleaning, deepened for STEP 2/3"),
