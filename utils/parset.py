...
option_list = ( ( 'machine', 'NCPU_DDF', int, getcpus(),
                ...
                ( 'solutions', 'uvmin_very_slow', float, 0.5, 'Minimum baseline length to use in self-calibration (km)' ),
                ...
                ( 'compression', 'delete_compressed', bool, False, 'Delete original files after compression'),
